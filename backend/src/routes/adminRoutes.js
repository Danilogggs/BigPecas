...
router.post('/usuarios/admin', controller.criarContaAdmin);
router.patch('/usuarios/:id', controller.editarUsuario);
router.delete('/usuarios/:id', controller.removerUsuario);
router.delete('/usuarios/:id/permanente', controller.removerUsuarioPermanente);
router.patch('/usuarios/:id/admin', controller.atualizarAdmin);
router.get('/pecas', controller.pecas);
router.patch('/pecas/:id', controller.editarPeca);
router.delete('/pecas/:id', controller.removerPeca);
router.delete('/pecas/:id/permanente', controller.removerPecaPermanente);
...
router.patch('/avaliacoes/:tipo/:id', controller.editarAvaliacao);
