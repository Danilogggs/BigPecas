...
export function mapFirebaseAuthError(error, context = 'generic') {
  ...
  const contextMessages = {
    login: {
      ...
      'auth/too-many-requests': 'Muitas tentativas de acesso. Aguarde alguns instantes e tente novamente.',
      'auth/network-request-failed': DEFAULT_MESSAGES.network,
    },
    register: {
      'auth/email-already-in-use': 'Este email já está cadastrado.',
      'auth/invalid-email': 'Informe um email válido.',
      'auth/weak-password': 'Sua senha é muito fraca. Use pelo menos 8 caracteres.',
      'auth/network-request-failed': DEFAULT_MESSAGES.network,
    },
    resetPassword: {
      'auth/invalid-email': 'Informe um email válido.',
      'auth/user-not-found': 'Não encontramos uma conta com esse email.',
      'auth/missing-email': 'Informe seu email para continuar.',
      'auth/too-many-requests': 'Muitas tentativas realizadas. Aguarde um instante e tente novamente.',
      'auth/network-request-failed': DEFAULT_MESSAGES.network,
      'auth/invalid-action-code': 'O link de recuperação é inválido ou expirou.',
      'auth/expired-action-code': 'O link de recuperação expirou. Solicite um novo email.',
    },
  };
  ...
  return contextMessages[context]?.[code] || parseUnexpectedError(error, defaultMessages[context] || defaultMessages.generic);
}
