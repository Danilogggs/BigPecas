...
import {
  ...
  FORMULARIO_PECA_INICIAL as INITIAL_FORM,
  normalizarCodigoPeca as normalizeCode,
...
export default function EditarPecas() {
  ...
  const { errors, setErrors, validate, clearFieldError } = useFormValidation(t);
  const {
    imageInputRef,
    imagemPreview,
    setImagemPreview,
  ...
  const filteredPecas = useMemo(
    () => filtrarPecasPorTexto(pecas, pecasSearchQuery),
