              ...
              {profileStatus.loading ? (
                ...
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: SPACING.LG }}>
                  <div>
                    ...
                    <p style={{ color: BORDEAUX, fontWeight: 600 }}>{profileStatus.data?.full_name || 'Não informado'}</p>
                  </div>
                  <div>
                  ...
                  <div>
                    ...
                    <p style={{ color: BORDEAUX, fontWeight: 600 }}>{profileStatus.data?.gender || 'Não informado'}</p>
                  </div>
                  <div>
                  ...
                  <div style={{ gridColumn: '1 / -1' }}>
                    <p style={{ color: '#9B7B6A', marginBottom: SPACING.SM, fontSize: '0.85rem' }}>ID do usuário</p>
                    <p style={{ color: BORDEAUX, fontWeight: 600, wordBreak: 'break-all', fontSize: '0.85rem' }}>
                      {profileStatus.data?.id || user?.id || 'Não disponível'}
                    </p>
                  </div>
                </div>
              )}
