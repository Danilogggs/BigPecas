...
import { SPACING, GRID_TWO_COLUMNS, COLORS } from '../styles/theme';
...
export default function CadastroUsuario() {
  ...
  return (
    <AuthCard
      eyebrow="BigPeças"
      title="Criar conta"
      subtitle="Preencha seus dados para criar uma nova conta."
      wide
      alignTop
    >
      {message.text &&
      ...
      <div style={{ marginTop: SPACING.XL, fontSize: '0.875rem', color: COLORS.MUTED_TEXT }}>
        Já possui conta?{' '}
